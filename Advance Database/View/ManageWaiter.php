<?php
    ...
    $s = oci_parse($connection, "select * from waiters");
    oci_execute($s);
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div>
        <div>
            <a class="action-btn" href="./AddWaiter.php">Add Waiter</a>
        </div>
        <br><br>
        <div>
            <a class="action-btn" href="./SearchWaiter.php">Search Waiter</a>
        </div>
    </div>
        ...
        <tbody>
            <?php
                ...
                echo "<tr>";
                    ...
                    echo "<td>".$row[2]."</td>";
                    echo "<td>".$row[3]."</td>";
                    echo "<td><a class='table-link' href='../Controller/RemoveWaiter.php?id=$row[0]'>Remove</a></td>";
                echo "</tr>";
            }
            ?>
        </tbody>
