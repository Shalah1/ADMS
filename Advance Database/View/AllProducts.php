...
{
header("Location: ../View/ManagerLogin.php"); // Redirecting To Login Page
}
?>
<!DOCTYPE html>
<html>
...
while( ($row = oci_fetch_row($result)) != false) {
      ...
      echo "<td><a href=UpdateProduct.php?id=".$row[0]." style='color:blue;font-size:15';>Edit </a>";
      echo "<a href=../Controller/Delete.php?id=".$row[0]." style='color:red;font-size:15';> Delete</a>  </td>";
